...
public class GarbageCollectionReview {
    ...
    public static void main(String[] args) {
        ...
        str1 = null;
        System.out.println(str1); //GC

        String s1 = new String("John");
        String s2 = new String("Aaron");

        s1 = s2; // "John" is eligible for GC

        System.out.println(s1+" : "+s2);

        System.out.println("========================================");

        Circle c1 = new Circle(3); // is eligible for GC
        c1 = null;
        ...
        String a1 = "Cybertek"; // is eligible for GC
        a1 = null;
